...
test('Check comment shouldRenderBoders method', async () => {
    ...
    expect(
        (await (new FlatComment(undefined as any, commentQuestion, controller)).generateFlatsContent({ xLeft: 0, yTop: 0 }) as any)[0]['shouldRenderFlatBorders']()).toBeTruthy();
    expect(
        (await (new FlatTextbox(undefined as any, textQuestion, controller)).generateFlatsContent({ xLeft: 0, yTop: 0 }) as any)[0]['shouldRenderFlatBorders']()).toBeTruthy();
    expect(
        (await (new FlatDropdown(undefined as any, dropdownQuestion, controller)).generateFlatsContent({ xLeft: 0, yTop: 0 }) as any)[0]['bricks'][1]['shouldRenderFlatBorders']()).toBeTruthy();
    ...
    expect(
        (await (new FlatComment(undefined as any, commentQuestion, controller)).generateFlatsContent({ xLeft: 0, yTop: 0 }) as any)[0]['shouldRenderFlatBorders']()).toBeFalsy();
    expect(
        (await (new FlatTextbox(undefined as any, textQuestion, controller)).generateFlatsContent({ xLeft: 0, yTop: 0 }) as any)[0]['shouldRenderFlatBorders']()).toBeTruthy();
    expect(
        (await (new FlatDropdown(undefined as any, dropdownQuestion, controller)).generateFlatsContent({ xLeft: 0, yTop: 0 }) as any)[0]['bricks'][1]['shouldRenderFlatBorders']()).toBeFalsy();
    ...
    expect(
        (await (new FlatComment(undefined as any, commentQuestion, controller)).generateFlatsContent({ xLeft: 0, yTop: 0 }) as any)[0]['shouldRenderFlatBorders']()).toBeTruthy();
    expect(
        (await (new FlatTextbox(undefined as any, textQuestion, controller)).generateFlatsContent({ xLeft: 0, yTop: 0 }) as any)[0]['shouldRenderFlatBorders']()).toBeFalsy();
    expect(
        (await (new FlatDropdown(undefined as any, dropdownQuestion, controller)).generateFlatsContent({ xLeft: 0, yTop: 0 }) as any)[0]['bricks'][1]['shouldRenderFlatBorders']()).toBeTruthy();
