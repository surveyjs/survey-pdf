...
import { IPoint, IRect, ISize } from '../src/doc_controller';
...
test('Check one image 16x16px file', async () => {
    ...
    let assumeFile: IRect = {
        xLeft: survey.controller.leftTopPoint.xLeft,
        xRight: survey.controller.leftTopPoint.xLeft + imageSize.width,
        yTop: survey.controller.leftTopPoint.yTop,
        yBot: survey.controller.leftTopPoint.yTop + imageSize.height +
...
test('Check one image 16x16px file', async () => {
    ...
    let assumeFile: IRect = {
        xLeft: survey.controller.leftTopPoint.xLeft,
        xRight: survey.controller.leftTopPoint.xLeft + survey.controller.measureText(json.elements[0].defaultValue[0].name).width,
        yTop: survey.controller.leftTopPoint.yTop,
        yBot: survey.controller.leftTopPoint.yTop + imageSize.height +
            survey.controller.unitHeight * (1.0 + FlatFile.IMAGE_GAP_SCALE)
    };
