...
// test.skip('Check imagepicker one image 100x100px', async () => {
//     let json = {
//         elements: [
//             {
//                 type: 'imagepicker',
...
// });
// test.skip('Check imagepicker one image 100x100px with label', async () => {
//     let json = {
//         elements: [
//             {
//                 type: 'imagepicker',
...
//     TestHelper.equalRect(expect, flats[0][0], assumeimagePicker);
// });
// test.skip('Check imagepicker two images 100x100px', async () => {
//     let json = {
//         elements: [
//             {
//                 type: 'imagepicker',
