...
api-type: class
description: A plugin that enables you to fill interactive fields in existing PDF forms.
source: https://surveyjs.io/pdf-generator/documentation/api-reference/pdfformfiller
---
